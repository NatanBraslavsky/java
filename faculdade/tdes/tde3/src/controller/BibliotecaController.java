...
public class BibliotecaController {
    ...
    public void adicionarItem(ItemBiblioteca item) throws CampoVazioException {
        if (item.getTitulo().isEmpty()) throw new CampoVazioException("Título não pode ser vazio.");
        itens.add(item);
    }
    ...
    public void removerPorTitulo(String titulo) throws ItemNaoEncontradoException {
